...
const SUGGESTIONS = [
	{
		icon: "💧",
		tint: {
			dark: "rgba(0, 163, 255, 0.18)",
			light: "rgba(0, 106, 190, 0.16)",
		},
		label: "Where to LP",
	...
	},
	{
		icon: "⚖️",
		tint: {
			dark: "rgba(255, 0, 163, 0.15)",
			light: "rgba(190, 0, 120, 0.14)",
		},
	...
	},
	{
		icon: "📈",
		tint: {
			dark: "rgba(255, 196, 0, 0.18)",
			light: "rgba(180, 130, 0, 0.18)",
		},
		...
		<div
			...
			<form
				...
				<p
					...
					Answers come from live indexed chain data — still,
					double-check before acting on them.
				</p>
			</form>
		</div>
	);
